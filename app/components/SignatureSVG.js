// The Mitarth Pathak signature as inline SVG. Shared by the home intro/mark
// and the small mark in the case-study top bar. Stroke lengths used by the
// draw-on animation live in app/styles/animation.css.
...
export default function SignatureSVG({ className, strokeWidth = SVG_PROPS.strokeWidth }) {
  return (
    <svg
